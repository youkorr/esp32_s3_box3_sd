...
async def to_code(config):
    ...
    mount_point = config[CONF_MOUNT_POINT]
    ...
    cg.add(
        cg.RawExpression(
            ...
            ESP_LOGI("SDPI", "SD card mounted at {mount_point}");
            '''
        )
    )
...
@automation.register_action("sd_mmc_card.write_file", SdMmcWriteFileAction, SD_MMC_WRITE_FILE_ACTION_SCHEMA)
...
@automation.register_action("sd_mmc_card.create_directory", SdMmcCreateDirectoryAction, SD_MMC_PATH_ACTION_SCHEMA)
...
@automation.register_action("sd_mmc_card.remove_directory", SdMmcRemoveDirectoryAction, SD_MMC_PATH_ACTION_SCHEMA)
...
@automation.register_action("sd_mmc_card.delete_file", SdMmcDeleteFileAction, SD_MMC_PATH_ACTION_SCHEMA)
